...
- [Overview](README-spec.md)
- [Rationale and positioning](RATIONALE.md)
- [Conformance requirements (normative)](NORMATIVE.md)
- [HTML safety profile (normative)](HTML_SAFETY.md)
- [Accessibility profile (normative)](ACCESSIBILITY.md)
