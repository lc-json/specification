...
|---|---|---|
| `html` | `ContentItem` | [`schemas/content-item.schema.json`](schemas/content-item.schema.json) |
| `customHtml` | `SignpostItem` | [`schemas/signpost-item.schema.json`](schemas/signpost-item.schema.json) |
...
- [`schemas/content-item.schema.json`](schemas/content-item.schema.json) — `html` field
- [`schemas/signpost-item.schema.json`](schemas/signpost-item.schema.json) — `customHtml` field
